...
var grade = function grade(x) {
    console.log("words per: " + (wordsPerSentence(x)-1));
    console.log("syllables per: " + syllablesPerWord(x));  
    return 0.39 * (wordsPerSentence(x)-1) + 11.8 * syllablesPerWord(x) - 15.59 + 2;  //padded with +2
};
